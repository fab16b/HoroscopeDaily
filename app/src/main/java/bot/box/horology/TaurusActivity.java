...
public class TaurusActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView textView = findViewById(R.id.taurus_textView);
        textView.setMovementMethod(new ScrollingMovementMethod());

        Button button = findViewById(R.id.taurus_today_button);
        button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                System.out.println("here is the aries 01");
                Horoscope hAries = new Horoscope.Zodiac(TaurusActivity.this)
                        .showLoader(false)
    ...
    private void showHoroscope(Zodiac z, boolean isSuccsess, String errormsg) {
        ...
        TextView date = findViewById(R.id.taurus_date);
