...
public class LeoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView textView = findViewById(R.id.leo_textView);
        textView.setMovementMethod(new ScrollingMovementMethod());

        Button button = findViewById(R.id.leo_today_button);
        button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                System.out.println("here is the aries 01");
                Horoscope hAries = new Horoscope.Zodiac(LeoActivity.this)
                        .showLoader(false)
    ...
    private void showHoroscope(Zodiac z, boolean isSuccsess, String errormsg) {
        ...
        TextView date = findViewById(R.id.leo_date);
        TextView body = findViewById(R.id.leo_textView);
