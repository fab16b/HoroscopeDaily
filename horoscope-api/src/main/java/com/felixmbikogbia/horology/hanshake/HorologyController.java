package com.felixmbikogbia.horology.hanshake;

import android.content.Context;
import android.net.ConnectivityManager;
import android.net.NetworkInfo;

import com.felixmbikogbia.horology.api.Horoscope;
import com.felixmbikogbia.horology.delegate.Response;
import com.felixmbikogbia.horology.encode.Crypto;
...
public class HorologyController implements Response {
    ...
    public HorologyController(Response mResponse) {
        if (mResponse != null)
            ...
            throw new IllegalStateException("Activity must imeplement Response");
    ...
    public void requestConstellations(Horoscope mObject) {
        if (mObject != null && mObject instanceof Horoscope) {
            ...
            throw new IllegalArgumentException("Only not null object of Horoscope is a valid argument");
    }
